export const modelCardData = {
  ...
  heartfailure: {
    ...
    // Additional Heart Failure-specific fields
    ...
    certificationDetails: "ASTP Health IT Certification Program\\nCriterion: 170.315(a)(9) Clinical Decision Support\\nCertificate #: 15.07.07.3072.IC13.01.00.1.231204",
    
    // Contact Information
    clinicalSupport: "clinical.ai@cerner.com\n1-800-237-6371",
    technicalSupport: "integration.support@cerner.com\nDeveloper Portal: developer.cerner.com",
    regulatoryAffairs: "regulatory@cerner.com\nASTP Certification ID: 3072",
    ...
    intendedUse: "Clinical decision support for heart failure development risk assessment",
    certificationStatus: "ASTP Certified Health IT Module (2025)",
    modelType: "Ensemble Machine Learning Model",
    outputProvided: "5-year heart failure risk with stage classification and EF categorization",
    endUsers: "Licensed clinicians using certified EHRs in cardiology and primary care",
    demographicsInputs: "Age (45+ years), Sex, Race/Ethnicity",
    laboratoryInputs: "BNP/NT-proBNP, Troponin, BUN, Creatinine, Hemoglobin",
    clinicalInputs: "Ejection Fraction, Blood Pressure, Heart Rate, Body Mass Index",
    medicalHistoryInputs: "Coronary Disease, Diabetes, Hypertension, Previous MI, Medication History",
    performanceMetrics: {
      auroc: "0.78",
      sensitivity: "74.8%",
      specificity: "72.6%",
    ...
    internalValidation: "Cross-validation on 38,000 patients from Framingham and MESA cohorts",
    externalValidation: "Validated on ARIC and Jackson Heart Study cohorts (n=31,000)",
    realWorldPerformance: "Deployed across 112+ health systems, continuous performance monitoring",
    targetUse: "Early detection and risk stratification for heart failure development",
    intendedPopulation: "Adults aged 45+ years at risk for or with early-stage heart failure",
    clinicalSetting: "Cardiology clinics, heart failure centers, primary care practices",
    exclusions: [
      "Patients under 45 years of age",
      "End-stage heart failure (Stage D) patients",
      "Heart transplant recipients or candidates",
    ...
    limitations: [
      "Not for diagnosis or sole clinical decision-making",
      "Performance may vary with borderline ejection fraction measurements",
      "Requires recent echocardiographic data for optimal performance",
      "Clinical judgment must always override algorithmic recommendations",
      "Performance affected by recent medication changes",
      "May underestimate risk in patients with complex comorbidities"
    ],
    biasConsiderations: "Enhanced focus on African American populations who have higher heart failure risk. Ongoing studies in diverse populations with particular attention to women and Hispanic patients.",
    biasStatus: "Complete"
  }
};